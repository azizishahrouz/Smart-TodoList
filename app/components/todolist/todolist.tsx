...
//   const removeTodo = (id: number) => setTodos((s) => s.filter((t) => t.id !== id));
...
//     if (!value) return;
//     setTodos((s) => s.map((t) => (t.id === id ? { ...t, text: value } : t)));
//     setEditingId(null);
//     setEditText("");
//   };
...
//         <h2 className="text-2xl md:text-3xl font-semibold text-slate-800">Tasks</h2>
...
//                     {/** if date-fns not installed, replace with new Date(t.createdAt).toLocaleString() */}
//                     {format ? format(new Date(t.createdAt), "MMM d, HH:mm") : new Date(t.createdAt).toLocaleString()}
//                   </td>

//                   <td className="px-4 py-3 text-center">
//                     <button
//                       onClick={() => toggleDone(t.id)}
//                       className={`px-3 py-1 rounded-full text-sm transition ${t.done ? "bg-green-100 text-green-700" : "bg-yellow-50 text-yellow-800"}`}
//                       aria-pressed={t.done}
...
//                       {editingId === t.id ? (
//                         <>
//                           <button onClick={() => saveEdit(t.id)} className="text-sm px-3 py-1 rounded bg-indigo-600 text-white">
//                             Save
//                           </button>
//                           <button onClick={() => { setEditingId(null); setEditText(""); }} className="text-sm px-3 py-1 rounded border">
//                             Cancel
//                           </button>
//                         </>
//                       ) : (
//                         <>
//                           <button onClick={() => startEdit(t)} className="text-sm px-3 py-1 rounded border hover:bg-gray-50" aria-label={`Edit task ${idx + 1}`}>
//                             Edit
//                           </button>
//                           <button onClick={() => removeTodo(t.id)} className="text-sm px-3 py-1 rounded bg-red-100 text-red-700" aria-label={`Delete task ${idx + 1}`}>
//                             Delete
//                           </button>
//                         </>
//                       )}
